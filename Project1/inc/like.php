...
exit(0);
  ...
  function getRatings($id)
  {
    global $conn;
    $rating = array();
    $likes_query = "select COUNT(*) from post_votes where post_id = '$id' AND vote='like'";
    $dislikes_query = "select COUNT(*) from post_votes where post_id = '$id' AND vote='dislike'";
...
global $conn;
$sql = "select COUNT(*) from post_votes where post_id = '$id' AND vote = 'like'";
...
return $result[0];
  ...
  global $conn;
  $sql = "select COUNT(*) from post_votes where post_id = '$id' AND vote = 'dislike'";
  $rs = mysqli_query($conn,$sql);
  $result = mysqli_fetch_array($rs);
  return $result[0];
